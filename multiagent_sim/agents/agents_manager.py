...
class AgentsManager:
    ...
    def __init__(
        ...
        self.drones = DronesRegistry()
        self.users = UsersRegistry()
        self._create_agents()
    ...
    def _create_agents(self) -> None:
        ...
        for id in range(self.config.num_drones):
            drone = self._create_drone(global_id=global_id, type_id=id)
    ...
    def _create_drone(self, global_id: int, type_id: int) -> Drone:
