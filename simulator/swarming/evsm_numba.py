...
def calculate_exploration_force(
    ...
    # check if angles are inside sweep angle
...
def compile_all() -> None:
    calculate_links(np.zeros(2), np.zeros((1, 2)))
    calculate_control_force(np.zeros(2), np.zeros((1, 2)))
    calculate_damping_force(np.zeros(2))
    calculate_sweep_angle(np.zeros(2), np.zeros((1,2)))
    calculate_avoidance_force(np.zeros(1), np.zeros(2))
    calculate_exploration_force(np.zeros(1), np.zeros(2), np.zeros(2))
