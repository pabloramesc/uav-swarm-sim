...
def plot_limited_region(
    ...
    distances = obstacle.distance(pos_dense).reshape(X_dense.shape)
    directions = obstacle.direction(pos_sparse).reshape(X_sparse.shape + (2,))
    ...
    plt.plot(*obstacle.shape.exterior.xy, color="black")
