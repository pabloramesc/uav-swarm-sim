...
bounds_3857 = (left, right, bottom, top)

print("Bounds in EPSG:3857:", bounds_3857)

img, ext = ctx.bounds2img(*bounds_3857, zoom=10, source=ctx.providers.Esri.WorldImagery)
...
right_px = int((bounds_3857[1] - xmin_img) / pixel_size_x)
top_px = int((ymax_img - bounds_3857[2]) / pixel_size_y)
bottom_px = int((ymax_img - bounds_3857[3]) / pixel_size_y)
